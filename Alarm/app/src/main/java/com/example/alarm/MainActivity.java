    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupdButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //get selected values upon onclick of button and set the alarm
                //retrieving time picked from timepicker widget
                ...
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                    ...
                    //retrieving values selected from calendar widget
